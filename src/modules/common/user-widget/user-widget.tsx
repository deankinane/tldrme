...
export const UserWidget = (props: React.ComponentProps<'div'>) => {
	...
	return status === 'authenticated' ? (
		<div
			{...props}
			className={`${props.className} flex items-center rounded-3xl bg-[#00000088] p-2 text-sm font-thin text-white`}
		>
			<div className="rounded-full" onClick={() => setOpen(true)}>
				<UserIcon className="w-5" />
			</div>
			{open ? (
				<div className="absolute -right-2 -top-2 flex items-center rounded-md bg-[#00000088] p-2 pl-4 shadow-lg">
